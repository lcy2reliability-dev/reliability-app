...
**Status:** Core v1.18 deployed and verified live 2026-08-14. The 2026-08-14 and 2026-08-17 follow-ups below (job-card display, FWO parts no longer auto-linked, user-account fixes, admin Remove-user, session security, and Terms & Conditions / Privacy Policy acceptance) were deployed and verified live on 2026-08-17. The further 2026-08-17 refinements below (guided-tour and Job-list wording, the "does not replace APM" clarity, and the rename to "RME Shift Personal Tracker") are built and verified in the working copy but **not yet redeployed** — the live file is still the 2026-08-17 build. Firebase unchanged — still open (rules not yet published). The What's New banner marker was bumped for the 2026-08-17 batch, so the note re-appeared once for everyone; the displayed version stays 1.18. A second 2026-08-17 batch — a full guided-tour rewrite, a comprehensive role-aware Help & Reference page with a FAQ at the bottom, and switching thermal anomaly detection from the mean to the median — is also built into the same working copy and awaits the same redeploy. A third 2026-08-17 batch — tightening the split between what technicians and admins can change (screenshot ownership, field locking, and making decommission, delete, reactivate and creating new records admin-only), with the guided tour, Help page and FAQ updated to match — is built into the same working copy too and awaits the same redeploy.
